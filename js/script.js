					...
					onSlideChangeStart: (function (s) {
						return function (swiper) {
							...
							if ($(swiper.container).find('.preview__img')[0] !== undefined) {
								// Rutas locales de tus imágenes
								var prevImage = "./fondo.jpg";
								var nextImage = "./fondo.jpg";
							
								// Asignar las rutas locales a los botones de navegación previa y siguiente
								$(swiper.container).find('.swiper-button-prev .preview__img').css("background-image", "url(" + prevImage + ")");
								$(swiper.container).find('.swiper-button-next .preview__img').css("background-image", "url(" + nextImage + ")");
							}
